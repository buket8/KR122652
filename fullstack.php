...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT * FROM jobs WHERE category = 'Fullstack' AND (title LIKE '%$search_term%' OR description LIKE '%$search_term%')";
} else {
    $query = "SELECT * FROM jobs WHERE category = 'Fullstack'";
}
...
<head>
    ...
    <title>Обяви за работа - Fullstack</title>
</head>
<body>
    <div class="navbar">
        <div class="logo">
    ...
    <div class="job-list">
        ...
        if ($result && $result->num_rows > 0) {
            ...
            echo "<p>Няма публикувани обяви за работа в категория Fullstack.</p>";
        }
        ?>
    </div>
